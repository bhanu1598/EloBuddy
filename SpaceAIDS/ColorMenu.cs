namespace SpaceAIDS
{
    ...
    public static class ColorMenu
    {
        private static readonly Color[] Colors =
            {
                Color.Blue, Color.Red, Color.Yellow, Color.Green, Color.Purple,
                Color.Black, Color.Brown, Color.Gray, Color.Pink, Color.BlueViolet,
                Color.Aqua, Color.MidnightBlue, Color.Gold, Color.LimeGreen,
                Color.Violet, Color.WhiteSmoke, Color.DarkRed, Color.Violet,
                Color.IndianRed, Color.MediumVioletRed, Color.Orange, Color.OrangeRed
            };

        private static readonly string[] ColorsName =
            {
                "Blue", "Red", "Yellow", "Green", "Purple", "Black", "Brown",
                "Gray", "Pink", "BlueViolet", "Aqua", "MidnightBlue", "Gold",
                "LimeGreen", "Violet", "WhiteSmoke", "DarkRed", "Violet",
                "IndianRed", "Medium Violet Red", "Orange", "Orange Red"
            };
