namespace Rice
{
    ...
    public static class Extensions
    {
        ...
        public static void PredCast(this Spell.Skillshot spell, Obj_AI_Base target)
        {
            spell.Cast(target.IsRooted ? target.Position : spell.GetPrediction(target).CastPosition);
        }
